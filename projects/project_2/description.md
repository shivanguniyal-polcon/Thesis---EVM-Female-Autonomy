...
**Visualizations**
- `Step2_Covariate_Balance_Plot.png`: Bar chart showing massive positive gaps for Urbanization and Literacy in treated districts. Visual proof of selection bias.
- `Step2_EVM_Coef_Forest_Plot.png`: Dot plot with error bars showing the coefficient moving from -7.1 to -3.2 as controls are added. The second bar's error bar nearly crosses zero, visually indicating fragility.
