### Process Summary:
Merging 1991 and 1999 data across 543 constituencies, the analysis isolates 46 EVM-treated areas. A two-sample T-test and univariate OLS regression quantify the raw "EVM penalty" on female turnout, visualized via boxplots and maps.
